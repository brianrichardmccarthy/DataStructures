...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        /* double startTime = System.currentTimeMillis();
        // new Driver(new File("./src/larger-database.txt"), "./src/larger-databaseCompressed.txt");
        new Driver(new File("./src/test.txt"), "./src/testCompressed.txt");
        double currentTime = (System.currentTimeMillis() - startTime) / 1000;
        System.out.println("Total <" + currentTime + ">\n\n");
        
        /*double startTime = System.currentTimeMillis();
        new Driver(new File("./src/small-database.txt"), "./src/small-databaseCompressed.txt");
        double currentTime = (System.currentTimeMillis() - startTime) / 1000;
        System.out.println("Total <" + currentTime + ">\n\n");*/
        /* double startTime = System.currentTimeMillis();
        new Driver(new File("./src/test.txt"), "./src/testCompressed.txt");
        ...
        */
        /*startTime = System.currentTimeMillis();
        new Driver(new File("./src/SpanishWords.txt"), "./src/SpanishWordsCompressed.txt");
        currentTime = (System.currentTimeMillis() - startTime) / 1000;
        System.out.println("Total <" + currentTime + ">\n\n");
        ...
        // double startTime = System.currentTimeMillis();
        // new Driver(new File("./src/SpanishWords.txt"), "./src/SpanishWordsCompressed.txt");
        new Driver(new StringBuilder("GO GO GOPHERS"), "./src/gophersCompressed.txt");
        System.out.println("\n\n");
        new Driver(new StringBuilder("MISSISSIPPI RIVER"), "./src/mississippiCompressed.txt");
        // new Driver(new StringBuffer("BRIAN RICHARD MICHAEL MCCARTHY"), "./src/nameCompressed.txt");
        // new Driver(new File("./src/large-database.txt"), "./src/large-database.txt");
        /*double startTime = System.currentTimeMillis();
        new Driver(new File("./src/test.txt"), "./src/testCompressed.txt");
        double currentTime = (System.currentTimeMillis() - startTime) / 1000;
        System.out.println("Total <" + currentTime + ">");*/
